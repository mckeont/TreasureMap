...
switch(feature.properties.name) {
  case 'Borax Mine': return {color: "MidnightBlue", fillOpacity: 0.3, weight: 3};
  case 'unsure': return {color: "green", fillOpacity: 0.3, weight: 3};
  case 'Furnace Creek Campground': return {color: "red", fillOpacity: 0.3, weight: 3};
  case 'Timbisha': return {color: "tomato", fillOpacity: 0.3, weight: 3};
  default: return {
    color:"orange",
    fillOpacity: 0.3,
    weight: 3
